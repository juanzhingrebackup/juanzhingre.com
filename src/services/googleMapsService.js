...
class GoogleMapsService {
    ...
    async initialize() {
        ...
        console.warn = function(...args) {
            if (args[0] && typeof args[0] === 'string' && (args[0].includes('AutocompleteService') || args[0].includes('PlacesService'))) return;
        ...
        if (!apiKey) {
            console.error('Google Maps API key not found. Please set GOOGLE_MAPS_KEY in your Vercel environment variables.');
